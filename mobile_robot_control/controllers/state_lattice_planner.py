...
try:
    import TrajectoryGenerator.model_predictive_trajectory_generator as planner
    import TrajectoryGenerator.motion_model as motion_model
except ImportError:
    raise


table_path = os.path.dirname(os.path.abspath(__file__)) + "/TrajectoryGenerator/lookuptable.csv"
